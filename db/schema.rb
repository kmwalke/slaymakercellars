...
ActiveRecord::Schema[8.0].define(version: 20_250_323_160_121) do
  ...
  create_table 'towns', force: :cascade do |t|
    t.string 'name'
    t.integer 'state_id'
    t.index %w[name state_id], name: 'index_towns_on_name_and_state_id', unique: true
  end
  ...
  create_table 'xero_sync_errors', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[syncable_type syncable_id], name: 'index_xero_sync_errors_on_syncable'
  end
end
